  ...
  <div>
      ...
      <div id="terms" style="text-align: center; margin: auto; width: 80vw; padding-top: 10px;">
        ...
        <p>
          ...
          ("<b>you</b>") and Paradigm Development, Inc. ("<b>Company</b>", "<b>We</b>", "<b>us</b>", or "<b>our</b>"), concerning your access to and use of the
          www.theparadigm.ga website as well as any other media form, media channel, mobile website or mobile application related,
          ...
          <br><br>
          <b>IF YOU DO NOT AGREE WITH ALL OF THESE TERMS
        ...
        <p>
          ...
          foreign jurisdictions, and international conventions. The Content and the Marks are provided on the Site "AS IS" for your
        ...
        <p>
          ...
          <br>
          24. Except as may be the result of standard search engine or Internet browser usage, use, launch, develop, or distribute
        ...
        <p>
          ...
          and to authorize us, the Site, and other users of the Site to use your Contributions in any manner contemplated by the Site
          ...
          <br>
          8. Your Contributions do not advocate the violent overthrow of any government or incite, encourage, or threaten physical
          ...
          <br>
          11. Your Contributions do not contain any material that solicits personal information from anyone under the age of 18 or
          ...
          <br>
          14. Your Contributions do not otherwise violate, or link to material that violates, any provision of these Terms of Use, or any
        ...
        <p>
          ...
          <br>
          We have the right, in our sole and absolute discretion, (1) to edit, redact, or otherwise change any Contributions; (2) to re-
          categorize any Contributions to place them in more appropriate locations on the Site; and (3) to pre-screen or delete any
        ...
        <p>
          ...
          our sole discretion and without limitation, notice, or liability, to remove from the Site or othemise disable all files and content
          that are excessive in size or are in any way burdensome to our systems; and (5) othemise manage the Site in a manner
        ...
        <p>
          ...
          <br>
          When you visit our website www.theparadigm.ga, and use our services, you trust us with your personal information. We
          ...
          way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some
          ...
          <br>
          This privacy policy applies to all information collected through our website (such as www.theparadigm.ga), and/or any
        ...
        <h6>Information Sutomatically Collected</h6>
        <p>
        ...
        <p>
          ...
          <ul style="text-align: left;">
            <li><b>To facilitate account creation and logon process.</b> If you choose to link your account with us to a third party account *
            (such as your Google or Facebook account), we use the information you allowed us to collect from those third parties to
            facilitate account creation and logon process.</li>
            <li><b>To protect our Sites.</b> We may use your information as part of our efforts to keep our Sites safe and secure (for
            example, for fraud monitoring and prevention).</li>
            ...
            <li><b>To respond to legal requests and prevent harm.</b> If we receive a subpoena or other legal request, we may need to
            inspect the data we hold to determine how to respond.</li>
          </ul>
        </p>
        <h5>INFORMATION SHARING</h5>
        <p>
          <i><b>In Short:</b> We only share information with your consent to comply with laws, to protect your rights, or to fulfill business
          obligations.</i>
          <br>
          We may process or share data based on the following legal basis:
          <br>
          <ul style="text-align: left;">
            <li><b>Consent:</b> We may process your data if you have given us specific consent to use your personal information in a
            specific purpose.</li>
            <li><b>Legitimate Interests:</b> We may process your data when it is reasonably necessary to achieve our legitimate business
            interests.</li>
            ...
            <li><b>Legal Obligations:</b> We may disclose your information where we are legally required to do so in order to comply with
            ...
            requirements).</li>
            <li><b>Vital Interests:</b> We may disclose your information where we believe it is necessary to investigate, prevent, or take
            ...
            of any person and illegal activities; or as evidence in litigation In which we are Involved.</li>
          </ul>
          ...
          <ul style="text-align: left;">
            ...
            <li><b>Third-Party Advertisers:</b> We may use third-party advertising companies to serve ads when you visit the Sites These
            companies may use information about your visits to our Website(s) and other websites that are contaned in web cookies and
            other tracking technologies in order to provide advertisements about goods and services of interest to you.
            <li><b>Other Users:</b> When you share personal information (for example; by posting comments, contributions or other content to
            the Sites) or othenvise interact with public areas of the Sites; such personal information may be viewed by all users and may
            be publicly distributed outside the Sites in perpetuity Similarly, other users will be able to view descriptions of your activity
            communicate with you within our Sites, and view your profile.</li>
          </ul>
        </p>
        <h5>INFORMATION LIFESPAN</h5>
        <p>
          <i><b>In Short:</b> We keep your information for as long as necessary to fulfill the purposes outlined in this privacy policy unless
          otherwise required by law.</i>
          <br>
          ...
          this policy will require us keeping your personal information for longer than the period of time in which users have an account
          with us.
          <br>
        ...
        <p>
          ...
          secure. Although we will do our best to protect your personal information, transmission of personal information to and from our
          Sites is at your own risk. You should only access the services within a secure environment.
        </p>
        <h5>INFORMATION OF MINORS</h5>
        <p>
          <i><b>In Short:</b> We do not knowingly collect data from or market to children under 18 years of age.</i>
          We do not knowingly solicit data from or market to children under 18 years of age. By using the Sites, you represent that you
          are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent's use of the Sites.
          ...
          and take reasonable measures to promptly delete such data from our records. If you become aware of any data we have
          collected from children under age 18, please contact us at <a href="mailto:myka@theparadigm.ga">myka@theparadigm.ga</a>.
        </p>
        ...
        <p>
          ...
          here: <a href="ec.europa.eu/justice/data-protection/bodies/authorities/index_en.html">ec.europa.eu/justice/data-protection/bodies/authorities/index_en.html</a>
          <br>
        </p>
        ...
        <p>
          ...
          databases. However, some information may be retained in our files to prevent fraud, troubleshoot problems, assist with any
          investigations, enforce our Terms of Use and/or comply with legal requirements.
          <br>
          <ins><b>Opting out of email marketing:</b></ins> You can unsubscribe from our marketing email list at any time by clicking on the unsubscribe
          link in the emails that we send or by contacting us using the details provided below. You will then be removed from the
          marketing email list — however, we will still need to send you service-related emails that are necessary for the administration
          and use of your account. To othemise opt-out, you may:
          <br>
          <ul style="text-align: left;">
        ...
        <h5>CONTROLS FOR DO-NOT-TRACK (DNT) FEATURES</h5>
        <p>
          ...
          collected. No uniform technology standard for recognizing and implementing DNT signals has been finalized. As such, we do
          not currently respond to DNT browser signals or any other mechanism that automatically communicates your choice not to be
          tracked online. If a standard for online tracking is adopted that we must follow in the future, we will inform you about that
          practice in a revised version of this Privacy Policy.
        </p>
        <h5>CALIFORNIA-SPECIFIC PRIVACY RIGHTS</h5>
        <p>
          <i><b>In Short:</b> Yes, if you are a resident of California, you are granted specific rights regarding access to your personal
          information.</i>
          <br>
          ...
          that you reside in California. We will make sure the data is not publicly displayed on the Sites, but please be aware that the
        ...
        <p>
          ...
          Notification. Please be advised that pursuant to federal law you may be held liable for damages if you make material
        ...
        <p>
          ...
          Commonwealth of Pennsylvania applicable to agreements made and to be entirely performed within the Commonwealth of
        ...
        <p>
          ...
          applicable law; the arbitration will take place in United States County, Pennsylvania. Except as otherwise provided herein; the
          ...
          state and federal courts located in United States County, Pennsylvania, and the Parties hereby consent to; and waive all
          ...
          <br>
          In no event shall any Dispute brought by either Party related in any way to the Site be commenced more than one (1) years
          after the cause of action arose If this provision is found to be illegal or unenforceable, then neither Party will elect to arbitrate
          any Dispute falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall be decided
        ...
        <h5>EXCEPTIONS TO INFORMAL NEGOTIATIONS AND ARBITRATIONS</h5>
        <p>
        ...
        <p>
          ...
          YOU TO US. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION
        ...
        <p>
          ...
          attorneys' fees and expenses, made by any third party due to or arising out of: (1) your Contributions; (2) use of the Site; (3)
          breach of these Terms of Use; (4) any breach of your representations and warranties set forth in these Terms of Use; (5) your
          violation of the rights of a third party, including but not limited to intellectual property rights; or (6) any overt harmful act toward
          any other user of the Site with whom you connected via the Site. Notwithstanding the foregoing, we reserve the right, at your
          expense, to assume the exclusive defense and control of any matter for which you are required to indemnify us, and you
          agree to cooperate, at your expense, with our defense of such claims. We will use reasonable efforts to notify you of any such
        ...
        <p>
          ...
          you electronically, via email and on the Site, satisfy any legal requirement that such communication be in writing. YOIJ
          ...
          BY IJS OR VIA THE SITE. You hereby waive any rights or requirements under any statutes, regulations, rules, ordinances, or
